...
print(f'Container: {s.container_width}, Border radius: {s.border_radius_preset}, Shadow: {s.shadow_preset}')
print()
print('=== Pages ===')
...
print(f'Container: {s.container_width}')
print(f'Border radius: {s.border_radius_preset}')
print(f'Shadow: {s.shadow_preset}')
